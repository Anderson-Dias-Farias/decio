    ...
    <section className="relative bg-gradient-to-r from-primary to-secondary text-white overflow-hidden min-h-[50vh] sm:min-h-[90vh] flex items-center justify-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 h-full min-h-[100%] flex items-center justify-start w-full">
        ...
        >
          ...
          >
            Soluções e produtos pensados para facilitar sua jornada — tudo em um
            só lugar, com conforto e praticidade!
          </motion.p>
          <motion.span
            onClick={() => scrollToNextSection("viagem")}
            className="flex items-center gap-2 cursor-pointer text-green-500 cursor-pointer"
          >
      ...
      <div className="absolute top-0 right-0 left-0 bottom-0">
        <Image
          src="/assets/hero-variedades.png"
          alt="Homem sorrindo"
          fill
